...
var OBJMTLLoader = (function (_super) {
    ...
    OBJMTLLoader.prototype.load = function (url, mtlurl, onLoad, onProgress, onError) {
        ...
        mtlLoader.setCrossOrigin(scope.crossOrigin);
     ...
     */
    OBJMTLLoader.prototype.parse = function (data, mtllibCallback) {
        ...
        function add_face(a, b, c, normals_inds) {
            if (normals_inds === undefined) {
                geometry.faces.push(face3(parseInt(a) - (face_offset + 1), parseInt(b) - (face_offset + 1), parseInt(c) - (face_offset + 1), null));
            }
            else {
...
exports.OBJMTLLoader = OBJMTLLoader;
;
